...
| Project | Description |
|----------|-------------|
| [**NITA internship Drone Forensics**](https://github.com/AnshulRajkumar/NIT_internship) | An AI/ML Trained Drone View Object Detection Model for Drones helpful for Survillience , Developed during internship in NITA |
...
| [**PlayGround-NFSU**](https://playgroundnfsu.vercel.app) | A Website made specially for NFSU-Tripura for its events. |
